    ...
    return (
        <div data-aos="fade-up" className="max-w-6xl mx-auto px-6 py-14 bg-[#0D1A38] text-white rounded-2xl mt-20 shadow-lg">
            <div className="text-center">
                ...
                <p data-aos="fade-up" className=" max-w-3xl text-gray-400  mx-auto  leading-relaxed">
            ...
            <div data-aos="fade-up" className="flex flex-wrap justify-center gap-8 text-center mt-10">
                <div>
